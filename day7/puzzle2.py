...
def solve_puzzle(input: str):
    ...
    mapping_table = str.maketrans({
        'A': 'a', 'K': 'b', 'Q': 'c', 'T': 'd', '9': 'e', '8': 'f',
        '7': 'g', '6': 'h', '5': 'i', '4': 'j', '3': 'k', '2': 'l', 'J': 'm' 
    })
    ...
    # for origin_hand, bid in hands.items():
        ...
        if 'm' in group and group['m'] != 5:
            joker_cnt = group.pop('m')
            max_comb_card = max(group, key=group.get)
            group[max_comb_card] += joker_cnt
